...
export const HomeCenteredArea = styled.div`
  ...
  padding-top: ${tachyons.spacing.s4};
  padding-bottom: ${tachyons.spacing.s4};
`;
...
export const HomeHeadline = styled.h5`
      ...
      line-height: 1;
      font-weight: ${tachyons.weight.fw2};
      font-size: ${tachyons.size.f2};
`;

export const HomeBoldHeadline = styled.span`
      font-weight: ${tachyons.weight.fw7};
`;

export const SubHeadline = styled.h5`
      color: ${colors.homeSubheadline};
      font-weight: ${tachyons.weight.fw2};
...
<HomeCenteredArea>
<HomeHeadline>
Hi, I'm <HomeBoldHeadline>Slyvon Blanco</HomeBoldHeadline></HomeHeadline>
<SubHeadline>
