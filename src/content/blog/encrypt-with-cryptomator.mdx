...
2. Cryptomator will mount the vault as a virtual drive on your system. This drive will behave like a normal folder, allowing you to drag and drop files into it.
...
4. Lastly (and most importantly): close the virtual drive by **locking the vault in Cryptomator** when you're done adding your files. After locking the vault, the virtual drive will "eject" and be inaccessible.
